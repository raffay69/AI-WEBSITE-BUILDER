    ...
    >
      <main className="flex-1 flex flex-col h-screen">
        ...
        <div className="flex justify-between p-6 ">
          {" "}
          {/* remove flex justify-between next month */}
          <Logo2 />
        ...
        <div className="fixed bottom-4 right-4 w-auto max-w-[250px] z-10">
          <BackgroundGradient
            colorTheme="purple"
            className="relative rounded-3xl p-4 bg-black/95 hover:bg-black transition-all duration-300 border border-[#8A2BE2]/30 hover:border-[#8A2BE2]/40"
          >
            {/* Main glow layer */}
            ...
            <div className="flex items-center gap-3">
              <div className="flex-1 min-w-0">
                <p className="text-xs text-[#B98DF0]/90 truncate">Created by</p>
